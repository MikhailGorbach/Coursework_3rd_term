...
List* NewTable(int* counter, bool skip_cinget);				//Начальное создание таблицы
...
void WriteReport(int sum, float perc);						//Вывод данных в отчёт
string ReadReport();										//Чтение данных из файла отчёта